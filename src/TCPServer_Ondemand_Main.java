			...
			while ((socket = ss.accept()) != null) {
				...
				try
				{
					while (true) 
					{
						...
						String videoFile = videoPath + Integer.toString(fid) + ".mp4";
						...
						*/
						...
						System.out.println("fid: " + Integer.toString(fid) + "; Send: " + Long.toString(System.currentTimeMillis() - start_send));
						System.out.println("fid: " + Integer.toString(fid) + "; Read File + Send: " + Long.toString(System.currentTimeMillis() - start_rs));
						System.out.println("fid: " + Integer.toString(fid) + "; Input Proc + Read File + Send: " + Long.toString(System.currentTimeMillis() - start_input));
						os.flush();
